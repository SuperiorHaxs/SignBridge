...
Output: research_artifacts/posters/data_augmentation_onepager.png (and .pdf)
"""
...
def main():
    ...
    # Save (script lives in research_artifacts/generators/, write outputs to ../posters/)
    out_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'posters')
