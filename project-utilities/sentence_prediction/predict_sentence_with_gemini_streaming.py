...
# Path setup: this script lives at project-utilities/sentence_prediction/
sys.path.insert(0, str(Path(__file__).parent))                          # for predict_sentence (same dir)
sys.path.insert(0, str(Path(__file__).parent.parent / "llm_interface")) # for gemini_conversation_manager
