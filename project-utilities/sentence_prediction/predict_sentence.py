...
# Add project-utilities (parent dir, since this script now lives at project-utilities/sentence_prediction/)
sys.path.insert(0, str(Path(__file__).parent.parent))

# Add segmentation package dir for motion_based_segmenter
sys.path.insert(0, str(Path(__file__).parent.parent / "segmentation"))

# Add OpenHands model path (project root is two levels up)
