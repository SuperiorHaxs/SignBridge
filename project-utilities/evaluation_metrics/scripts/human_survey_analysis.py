...
# File paths
EVAL_RESULTS_PATH = Path(__file__).parent.parent / "synthetic_evaluation" / "test-results" / "evaluation_results_gemini_t1_n53_v4" / "evaluation_results.json"
SURVEY_SENTENCES_PATH = Path(__file__).parent.parent / "synthetic_evaluation" / "test-results" / "evaluation_results_gemini_t1_n53_v4" / "human_survey_sentences.csv"
...
OUTPUT_DIR = Path(__file__).parent.parent / "synthetic_evaluation" / "test-results" / "evaluation_results_gemini_t1_n53_v4"
