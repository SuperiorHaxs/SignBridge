...
def main():
    ...
    # Write to research_artifacts/posters/ (script lives at evaluation_metrics/scripts/)
    _posters = Path(__file__).resolve().parent.parent.parent.parent / 'research_artifacts' / 'posters'
    _posters.mkdir(parents=True, exist_ok=True)
    output = str(_posters / 'chart_floor_optimization')
