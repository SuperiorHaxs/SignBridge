...
with open('synthetic_evaluation/test-results/evaluation_results/evaluation_results.json', 'r') as f:
    data = json.load(f)
...
# Write to file
report_path = 'synthetic_evaluation/test-results/evaluation_results/ctqi_v1_vs_v2_comparison_report.txt'
